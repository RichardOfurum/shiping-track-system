            ...
            <div class="card">
                <div class="card-header">
                   ...
                   <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-door-open-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="{{route('profile.create')}}" class="ml-5">
                                    ...
                                    <div class="track_list mt-2 mb-4">
                                      ...
                                      <div class="ml-5 ">
                                           @if ($profile->active == 1 )
                                            ...
                                            <a href="{{route('profile.show', $profile->id)}}" class="ml-5">
                                            ...
                                            <a href="{{route('profile.edit', ['profile' => $profile->id])}}" class="ml-5">
