            ...
            <div class="card">
                <div class="card-header">
                   ...
                   <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-door-open-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="" data-toggle="collapse" data-target="#addLocation" aria-expanded="false" aria-controls="collapseExample">
                        <span class="ml-5">
                ...
                <div class="card-body">
                    ...
                    <div class="container">
                       ...
                       <div class="row">
                            ...
                            <div class="col-md-12 collapse" id="addLocation">
                                 
                                <form action="{{route('location.store')}}" method="POST">

                                  @csrf
                                   <input type="number" name="profile_id" class="invisible" value="{{$profile->id}}">
                                  


                                   <div class="form-check mb-3">
                                    <input class="form-check-input" type="radio" name="color" id="exampleRadios2" value="gray"checked>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <button type="submit" class="btn btn-primary mt-3">Save New Location</button>
                                  </div>
                                </form>
                            </div>
